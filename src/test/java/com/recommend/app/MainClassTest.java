...
public class MainClassTest {
  ...
  public void testMainClassFourInputs() {
    ...
    MainClass.main(args1);
    Assert.assertTrue(output.toString().contains("Dead Presidents (1995) (http://www.imdb.com/title/tt0112819) Rating : 5.0"));
  ...
  public void testMainClassThreeInputs() {
    ...
    System.setOut(new PrintStream(output));
    MainClass.main(args1);
    Assert.assertTrue(output.toString().contains("Chungking Express (1994) (http://www.imdb.com/title/tt0109424) Rating : 5.0"));
    System.setOut(originalOutput);
  }
}