...
public class Arguments {
    ...
    void parseGender() throws ArgNotExistError{
        if (this.gender.toUpperCase().equals("F") || this.gender.toUpperCase().equals("M") || this.gender.toUpperCase().equals(""))
            this.gender = this.gender.toUpperCase();
        else
            throw new ArgNotExistError(this, 1);
    }
    void parseAge() throws ArgNotExistError{
        if (this.age.equals(""))
            ...
            if (ageToNum >= 0 && ageToNum < 18)
                this.age = "1";
            else if (ageToNum >= 18 && ageToNum <= 24)
                this.age = "18";
            else if (ageToNum >= 25 && ageToNum <= 34)
                this.age = "25";
            else if (ageToNum >= 35 && ageToNum <= 44)
                this.age = "35";
            else if (ageToNum >= 45 && ageToNum <= 49)
                this.age = "45";
            else if (ageToNum >= 50 && ageToNum <= 55)
                this.age = "50";
            else if (ageToNum >= 56)
                this.age = "56";
            else
                throw new ArgNotExistError(this, 2);
        }
    }
    void parseOccupation() throws ArgNotExistError{
        ...
        if (st1.equals("")) {
            ...
            if (!OCCUPATIONS_MAP.containsKey(st1)) {
                ...
                this.occupation = Integer.toString(OCCUPATIONS_MAP.get(st1.trim().toLowerCase().replaceAll("\\p{Z}", "")));
            }
        }
    }
